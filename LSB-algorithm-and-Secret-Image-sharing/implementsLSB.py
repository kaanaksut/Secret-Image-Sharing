...
def embed_image(cover_image_path, hidden_image_path, output_image_path):
    ...
    # Gizlenen resmi boyutlandır
    hidden_image = hidden_image.resize(cover_image.size)

    # Gizlenen resmi ikili forma dönüştür
    ...
    # Kaplayıcı resmin piksellerinin en az anlamlı bitlerini değiştirerek gizli resmi göm
    ...
    # Yeni steganografi görüntüsünü oluştur
...
# Resimleri gömme işlemi
embed_image("1.jpg", "2.jpg", "stego_image.jpg")
